...
window.onload = function(){
   ...
   // funcion calcular huella hidrica verde 
    ...
    function generar(){ 
        ...
        if(huellagris>huellaAzul || huellagris>huellaverde)
        {
            document.getElementById('imgRecomendacion').src = 'calculadora/Images/recomendacion1.png';
        }
    
        if(huellaAzul<huellaverde)
        {
            document.getElementById('imgRecomendacion').src = 'calculadora/Images/recomendacion3.png';
        }
        

        if(huellagris>0)
        {
            document.getElementById('imgRecomendacion').src = 'calculadora/Images/recomendacion2.png';
        }
